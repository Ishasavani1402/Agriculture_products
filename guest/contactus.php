                ...
                <!-- <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="info-item">
                            ...
                            <div class="info-content" >
                                <p>Smt. Tanuben & Dr. Manubhai Trivedi College of Information Science, Surat, Athwa Gate, Surat, Gujarat</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                <p>savaniisha57@gmail.com</p>
                                <p>hdiyora@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div> -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contact-form" style="margin:20px">
                            <h3 class="bold"><ins>Get In Touch With Us By Filling Form Below</ins> </h3>
