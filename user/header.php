...
<header class="main_header_area bg-grey">
                ...
                <div class="links links-right pull-right">
                    <ul>
                        ...
                        <?php
                              ...
                              {
                              ?>
                        <li class="bold"><a href="login.php"><i class="fa fa-sign-in-alt"></i> Login</a></li>
                            ...
                            <ul class="nav navbar-nav" id="responsive-menu">
                              ...
                              ?>
                                ...
                                <li class="submenu dropdown">
                                    <a href="dashboard.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="font-weight:bold">Welcome, <?php echo $_SESSION["name"]; ?> <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
                                    <ul class="dropdown-menu">
                                     <li><a href="addaddress.php">My Address</a></li>
                                     <li><a href="myorder.php">My order</a></li>
                                     <!-- <li><a href="myiteam.php">My iteam</a></li> -->
