...
if ($success === true)
{
             ...
             $result=mysqli_query($conn,"insert into tbl_orders (user_id,address_id,totalpayment,ispay,paymentmethod,trans_num,status) values('$userid','$address','$total','yes','online','$payid','pending')") or die(mysqli_error($conn));
