          ...
          <div class="col-md-6 m-auto">
            ...
            <div class="card card-primary">
              ...
              if(isset($_POST["btnsubmit"]))
              {
                ...
                $result = mysqli_query($conn,"update subcategory set subcatname='$subcatagoryname',catid ='$catid' where subcatid ='$id'")or die(mysqli_error($conn));
              ...
              <?php
              $id=$_GET["id"];
              $res = mysqli_query($conn,"select * from subcategory where subcatid ='$id'");
              ...
              <form id="form1"method="post">
                ...
                <div class="form-group">
                    ...
                    {
                      ?>
                              <option <?php if($row["catid"]==$updata["catid"]) { ?>selected <?php }?>value="<?php echo $row["catid"]; ?>"><?php echo $row["catname"]; ?></option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txtsubcatagory" class="form-control" id="txtsubcatagory" value="<?php echo $updata["subcatname"];?>">
                  </div>
