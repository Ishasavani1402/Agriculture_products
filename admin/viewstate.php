...
<div class="wrapper">
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                {
                  $id=$_GET["id"];
                  $result=mysqli_query($conn,"delete from state where stat_id ='$id'")or die(mysqli_error($conn));
  ...
  while($row=mysqli_fetch_assoc($result))
  {
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="?id=<?php echo $row["stat_id"];?>" class="btn bg-gradient-danger">Delete</a>
                    <a href="updatestate.php?id=<?php echo $row["stat_id"];?>" class="btn bg-gradient-warning">Edit</a>
                    </td>
                    <!-- <td>Win 95+</td> -->
                  </tr>
               <?php } ?>  
