...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if(isset($_POST["btnsubmit"]))
    {
      ...
      $id = $_GET["id"];
      $result = mysqli_query($conn,"update state set stat_name='$statename' where stat_id='$id'") or die(mysqli_error($conn));
  ...
  <?php
  $id= $_GET["id"];
  $res = mysqli_query($conn,"select * from state where stat_id ='$id'");
              ...
              <form id="form1"method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="txtstatename" class="form-control" id="txtstatename" value=<?php echo $update["stat_name"];?>>
                  </div>
                </div>
                <!-- /.card-body -->
